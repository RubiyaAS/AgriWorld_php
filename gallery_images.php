                    ...
                    <div class="greennature-navigation-wrapper">
                        <nav class="greennature-navigation" id="greennature-main-navigation">
                            <ul id="menu-main-menu-1" class="sf-menu greennature-main-menu">
                                ...
                                <li class="menu-item menu-item-has-children greennature-normal-menu"><a href="#" class="sf-with-ul-pre"><i class="fa fa-file-text-o"></i>Registration</a>
                                    <ul class="sub-menu">
                                        <li class="menu-item"><a href="farmer_reg.php">Farmer</a></li>
                                        <li class="menu-item"><a href="seller_reg.php">Seller</a></li>
                                ...
                                <li class="menu-item menu-item-has-childrenmenu-item menu-item-has-children greennature-mega-menu"><a href="login.php" class="sf-with-ul-pre"><i class="fa fa-globe"></i>Login</a>
