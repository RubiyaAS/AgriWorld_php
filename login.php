...
<link rel="icon" href="images/lo.jpg" class="lo">
 <meta charset="UTF-8" />
                ...
                <div class="greennature-header-container container">
                    ...
                    <div class="greennature-logo">
                        <div class="greennature-logo-inner">
                            ...
                            <h3 style="color:green">Agri-World</h3>		
...
<div class="greennature-navigation-wrapper">
                        ...
                        <nav class="greennature-navigation" id="greennature-main-navigation">
                            <ul id="menu-main-menu-1" class="sf-menu greennature-main-menu">
                                ...
                                <li class="menu-item menu-item-has-childrenmenu-item menu-item-has-children greennature-mega-menu"><a href="logout.php" class="sf-with-ul-pre"><i class=""></i></a>
		...
		<div class="main-agileinfo">
			<div class="agileits-top">
				<form action="logi_action.php" method="post">
					<input class="text email" type="text" name="username" placeholder="Username" required=""><br><br><br>
					<input class="text email" type="password" name="password" placeholder="password" required=""><br><br><br>
					<input type="submit" value="login" class="btn  bg-danger">
